  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card mb-2 p-3">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('save-community') }}" enctype="multipart/form-data">
                @csrf
            <!-- Post Title -->
            <div class="mb-3">
              <label for="postTitle" class="form-label">Community Name</label>
              <input type="text" class="form-control" id="postTitle" name="name" placeholder="What's on your mind?" />
            </div>
