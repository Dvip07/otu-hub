                ...
                <div class="card mb-2 p-3">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('community.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="postTitle" class="form-label">Community Description</label>
                                <textarea type="text" class="form-control" id="communityDescription" name="description"
                                    placeholder="What's on your mind?">
              </textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="file-upload-container">
                                    <div class="input-group">
                                        <label class="input-group-text" for="communityAvatar"><i
                                                class="bx bx-upload"></i></label>
                                        <input type="file" class="form-control" id="communityAvatar" name="avatar" />
                                    </div>
